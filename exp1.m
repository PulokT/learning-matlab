...
grid on;
subplot(2,2,[1 2]), plot(t,x) , xlabel ('time in seconds'), ylabel('signal value'),
...
y2=a*sin(2*pi*f*n2);
grid on;
subplot(2,2,4), stem(n2,y2), xlabel('indesx'), ylabel('signal values'), title(['Signal Sampled at',num2str(Fs), 'Hz'])
